...
export default function LoginPage() {
    ...
    const handleCallback = async () => {
      ...
      if (code) {
        ...
        try {
          ...
          if (success) {
            console.log('Login callback successful, redirecting to dashboard...');
          ...
          if (error?.code === 'USER_NOT_REGISTERED' || 
            ...
            const displayError = error?.message || "Terjadi kesalahan saat memproses login";
            showErrorToast(displayError);
  ...
  }, [searchParams, googleCallback, router, callbackProcessed, isProcessingCallback]);
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-200 dark:border-red-800">
              <p className="text-sm text-red-700 dark:text-red-300 leading-relaxed">
                {errorMessage || 'Akun Google Anda tidak ditemukan dalam sistem kami. Silakan hubungi administrator untuk mendaftarkan akun Anda terlebih dahulu.'}
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="text-center">
                <p className="text-xs text-muted-foreground">
                  Pastikan Anda menggunakan akun Google yang sudah didaftarkan oleh administrator
                </p>
              </div>
            </div>
          </CardContent>
